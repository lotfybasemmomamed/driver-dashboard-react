...
import { faPerson,faCar } from "@fortawesome/free-solid-svg-icons";
...
function SideBar() {
  ...
  return (
    <>
      ...
      <aside
        className={`
     top-[82px] left-0 h-screen p-4 flex flex-col bg-gray-50 shadow-xl 
    ...
    ${
      isActive ? "bg-blue-100 text-blue-500" : "hover:bg-gray-100 text-gray-700"
            ...
            >
              ...
              {menuBar && windowWidth > 768 && "drivers"}
            </NavLink>
    ...
    ${
      isActive ? "bg-blue-100 text-blue-500" : "hover:bg-gray-100 text-gray-700"
            ...
            >
              ...
              {menuBar && windowWidth > 768 && "routes"}
            </NavLink>
          </ul>
        </nav>
      </aside>
